...
public class ArrayManipulations 
{
    public static void main(String[] args) 
    {
        ...
        Arrays.sort(doubleArray); //sorting of given values 
        ...
        //filling 10-element array with 7s
        int[] filledIntArray = new int[10]; 
        Arrays.fill(filledIntArray, 7);
        displayArray(filledIntArray, "filledIntArray");
        
        //copying intArray into intArrayCopy
        ...
        //comparing intArray and filledIntArray for equality
        b = Arrays.equals(intArray, filledIntArray);
        System.out.printf("intArray %s filledIntArray\n",(b ? "==" : "!="));
        
        //searching intArray for the value 5
